...
func TypeEQ(v property.RepositoryType) predicate.Repository {
	return predicate.Repository(func(s *sql.Selector) {
...
func TypeNEQ(v property.RepositoryType) predicate.Repository {
	return predicate.Repository(func(s *sql.Selector) {
...
func TypeIn(vs ...property.RepositoryType) predicate.Repository {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TypeNotIn(vs ...property.RepositoryType) predicate.Repository {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
