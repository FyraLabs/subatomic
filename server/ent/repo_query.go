...
func (_q *RepoQuery) QueryRpms() *RpmPackageQuery {
	query := (&RpmPackageClient{config: _q.config}).Query()
...
func (_q *RepoQuery) QueryKey() *SigningKeyQuery {
...
func (_q *RepoQuery) WithRpms(opts ...func(*RpmPackageQuery)) *RepoQuery {
	query := (&RpmPackageClient{config: _q.config}).Query()
...
func (_q *RepoQuery) WithKey(opts ...func(*SigningKeyQuery)) *RepoQuery {
	query := (&SigningKeyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RepoQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Repo, error) {
	...
	if query := _q.withRpms; query != nil {
		if err := _q.loadRpms(ctx, query, nodes,
...
func (_q *RepoQuery) loadRpms(ctx context.Context, query *RpmPackageQuery, nodes []*Repo, init func(*Repo), assign func(*Repo, *RpmPackage)) error {
...
func (_q *RepoQuery) loadKey(ctx context.Context, query *SigningKeyQuery, nodes []*Repo, init func(*Repo), assign func(*Repo, *SigningKey)) error {
